...
describe "Todelete" do
  ...
  def login()
    ...
    @driver.find_element(:xpath, "//div[@id='new_mission_hub']/div/div/div[2]/div/div/input").send_keys "Pre Act1 Act2"
	sleep(2)
    ...
    @driver.find_element(:xpath, "//body[@id='admin']/div/div/div/div[2]/div/input").send_keys "Prequal Survey Pre Act1 Act2"
    ...
    @driver.find_element(:link, "Prequal Survey Pre Act1 Act2").click
	sleep(1)
	...
	sleep(1)
	@driver.find_element(:css, "li.q-builder-click.test-survey-new-exit").click
	sleep(1)
   ...
   @driver.find_element(:css, "strong.q-list-type-badge").click
	...
	@driver.find_element(:css, "textarea.test-activity-badge-name").send_keys "Prequal Survey Pre Act1 Act2 Badge name"
	@driver.find_element(:xpath, "//button[@ng-click='save()']").click
	sleep(2)
	
	@driver.find_element(:link, "Pre Act1 Act2").click
	sleep(1)
	end
	
	def create_activity1()
	...
	@driver.find_element(:css, "input.q-field.ng-pristine[placeholder='Type a activity name']").send_keys "Activity 1"
    ...
    @driver.find_element(:css, "textarea.mission-page-title").send_keys "Activity 1"
	sleep(1)
  ...
  def create_activity2()
	...
	sleep(3)
	@driver.find_element(:css, "input.q-field.ng-pristine[placeholder='Type a activity name']").clear
	@driver.find_element(:css, "input.q-field.ng-pristine[placeholder='Type a activity name']").send_keys "Activity 2"
    ...
    @driver.find_element(:css, "textarea.mission-page-title").send_keys "Activity 2"
	sleep(1)
	@driver.find_element(:css, "input.mission-goal").clear
	@driver.find_element(:css, "input.mission-goal").send_keys "10"
	...
	sleep(2)
	#@driver.find_element(:xpath,"//div[@class='ng-scope']/div[@class='mlogic-step ng-scope']/strong[3]").click
	#@driver.find_element(:xpath, "//td[@class='day active']/preceding-sibling::td[@class='day'][1]").click
	@driver.find_element(:xpath,"//div[@class='mlogic-step ng-scope']/following-sibling::strong[3]").click
