...
describe "Sharing Tools" do
  ...
  def create_activity()
    ...
    @driver.find_element(:xpath, "//div[@id='new_mission_hub']/div/div/div[2]/div/div/input").send_keys "Retail Review Activity"
	sleep(1)
	...
	@driver.find_element(:css, "input.ng-pristine[placeholder='Type a activity name']").send_keys "Retail Review Activity"
    ...
    @driver.find_element(:css, "textarea.mission-page-title").send_keys "Retail Review Activity"
	sleep(1)
	...
	sleep(1)
	@driver.find_element(:css, "textarea[ng-model='activity.retail_review.seed_phrase']").send_keys "Retail Review Instructions Retail Review Instructions Retail Review Instructions Retail Review Instructions Retail Review Instructions Retail Review Instructions Retail Review Instructions Retail Review Instructions "
	sleep(2)
...
def retailreview_uploadphoto()
	...
	@driver.save_screenshot "Screenshots/Retail_review_post.png"
  end
