...
describe "AccountThemeContactAssets" do
  ...
  it "test_account_theme_contact_assets" do
	...
	#Privacy
    @driver.find_element(:css, "#edit_policy_1731 > div.row > div.col-md-8 > div.form-group > #policy_name").clear
    @driver.find_element(:css, "#edit_policy_1731 > div.row > div.col-md-8 > div.form-group > #policy_name").send_keys "Privacy Name"
    @driver.find_element(:css, "#edit_policy_1731 > input[name=\"commit\"]").click
    @driver.find_element(:css, "#edit_policy_1731 > div.row > div.col-md-8 > div.form-group > #policy_text").clear
    @driver.find_element(:css, "#edit_policy_1731 > div.row > div.col-md-8 > div.form-group > #policy_text").send_keys "Privacy Text Privacy TextPrivacy TextPrivacy TextPrivacy TextPrivacy TextPrivacy Text\n\nPrivacy TextPrivacy TextPrivacy Text"
    @driver.find_element(:css, "#edit_policy_1731 > input[name=\"commit\"]").click
