...
class LoginFormTest < Test::Unit::TestCase
	def test_login_form_test
		begin
			...
			caps["name"] = "Verify Validation of shipping address on member profile"
			caps["build"] = "1.0"
	...
	sleep(1)
	#Verify Invalid shipping address
	@driver.find_element(:link, "Shipping Address").click
	sleep(1)
	@driver.find_element(:xpath, "//input[@value='Save Shipping Address']").click
	sleep(2)
	puts "Shipping address is inValid. See screen shot"
	@driver.save_screenshot "Screenshots/InvalidShippingaddress.png"
	#Verify Incomplete shipping address
	@driver.find_element(:link, "Shipping Address").click
	sleep(1)
	...
	@driver.find_element(:xpath, "//input[@value='Save Shipping Address']").click
	sleep(2)
	puts "Shipping address is Incomplete. See screen shot"
	@driver.save_screenshot "Screenshots/IncompleteShippingaddress.png"
	sleep(3)
	#Verify Valid shipping address
    @driver.find_element(:link, "Shipping Address").click
	sleep(1)
	Selenium::WebDriver::Support::Select.new(@driver.find_element(:id, "member_country")).select_by(:text, "United States")
	sleep(1)
    ...
    @driver.find_element(:xpath, "//input[@value='Save Shipping Address']").click
	sleep(2)
	puts "Shipping address is Valid. See screen shot"
	@driver.save_screenshot "Screenshots/ValidShippingaddress.png"
